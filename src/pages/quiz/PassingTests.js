  ...
  const introduction = [
    {
      title: "Зачем?",
      description:
        "Тесты IncDev  предназначены для того, чтобы подтверждать навыки, которые вы указали у себя.",
    },
    {
      title: "Почему именно тестирование?",
      description:
        "Тесты IncDev  заменяют первое техническое собеседование по любой вакансии.",
    },
    {
